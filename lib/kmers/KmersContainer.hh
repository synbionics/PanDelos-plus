...
namespace kmers {
    ...
    public:
         ...
         */
        inline kmerSet_tr getKmerSet() const noexcept;
         ...
         */
        inline void calculateKmers(KmerMapper& mapper) noexcept;
         ...
         */
        inline mapKey_t getSmallerKey() const noexcept;
         ...
         */
        inline mapKey_t getBiggerKey() const noexcept;
         ...
         */
        inline multipicity_t getSmallerKeyMultiplicity() const noexcept;
         ...
         */
        inline multipicity_t getBiggerKeyMultiplicity() const noexcept;
         ...
         */
        inline void printDictionary(std::ostream& os) const noexcept;
    };
    ...
    inline KmersContainer::kmerSet_tr
        KmersContainer::getKmerSet() const noexcept {
        return dictionary_;
    }
    ...
    inline KmersContainer::sequence_t
        KmersContainer::getAlphabet() const noexcept {
        return alphabet_;
    }
    inline KmersContainer::mapKey_t
        KmersContainer::getSmallerKey() const noexcept {
        return smallerKey_;
    }
    inline KmersContainer::mapKey_t
        KmersContainer::getBiggerKey() const noexcept {
        return biggerKey_;
    }

    inline KmersContainer::multipicity_t
        KmersContainer::getSmallerKeyMultiplicity() const noexcept {
        return smallerMultip_;
    }
    inline KmersContainer::multipicity_t
        KmersContainer::getBiggerKeyMultiplicity() const noexcept {
        return biggerMultip_;
    }

    inline void
        KmersContainer::printDictionary(std::ostream& os) const noexcept {
        std::cerr << "\naphabet: " << alphabet_;
